...
const columns = [
  ...
  { field: "parteReparada", headerName: "PARTE REPARADA", flex: 1, minWidth: 160 },
  { field: "tecnico", headerName: "TECNICO", flex: 1, minWidth: 160 },
  { field: "valorReparacion", headerName: "VALOR REPARACION", flex: 1, minWidth: 160 },
];
...
function CustomToolbar() {
  return (
    ...
    >
      ...
      <ExportCsv csvOptions={{ utf8WithBom: true, fileName: "mantenimientos" }} />
    </Toolbar>
  );
}
    ...
    <Container maxWidth="lg" sx={{ py: { xs: 2, sm: 3 } }}>
      <Box sx={{ textAlign: "center", mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Gestión mantenimientos a los vehiculos.
        </Typography>
      </Box>
          ...
          <Box sx={{ height: 460, px: 2, pb: 2 }}>
            <DataGrid
              ...
              initialState={{
                ...
                sorting: { sortModel: [{ field: "fechaMantenimiento", sort: "desc" }] },
              }}
               disableRowSelectionOnClick
              onRowClick={(params) => {
                // 👇 redirige a la ruta con el id de la fila
                navigate(`/mantenimiento/${params.row.id}`);
              }}
      ...
      <Tooltip title="Agregar Mantenimiento">
        <Fab
          color="primary"
          onClick={onFabClick}
          sx={{
